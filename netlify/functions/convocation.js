...
═══════════════════════════════════════════════════════════════
  ...
  3. Enregistrer — aucun redéploiement du site nécessaire
     (les fonctions relisent les variables à chaque appel)

  Le lien à envoyer à la cliente est alors :
  https://soulscript.pro/invitation-v4.html?d=NUMERO&t=JETON
